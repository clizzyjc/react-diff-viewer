...
class DiffViewer extends React.Component {
    constructor(props) {
        ...
        this.renderDiff = () => {
            ...
            console.log("```tryJSON ", generic_schema);
            var x;
      ...
      "required": [
        "asdasdasdasdsada"
            ...
            const { lineInformation, diffLines } = compute_lines_1.computeLineInformation(oldValue, newValue, disableWordDiff, compareMethod, listofErrors, result, schemaContent);
        ...
        this.getMoreData = () => {
            ...
            setTimeout(() => {
                this.setState({current:current.concat(data.slice(count.prev + 10, count.next + 10))})
        ...
        this.render = () => {
            ...
            const title = (leftTitle || rightTitle)
              ...
              const table = React.createElement("table", { className: classnames_1.default(this.styles.diffContainer, { [this.styles.splitView]: splitView }) },
